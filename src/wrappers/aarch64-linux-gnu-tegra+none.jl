# Autogenerated wrapper script for CUDA_Driver_jll for aarch64-linux-gnu-tegra+none
export cuda_inspect_driver, libcuda_compat, libcuda_debugger, libnvidia_gpucomp, libnvidia_nvvm, libnvidia_ptxjitcompiler, libnvidia_tileiras
...
JLLWrappers.@declare_library_product(libnvidia_gpucomp, "libnvidia-gpucomp.so.610.43.02")
...
JLLWrappers.@declare_library_product(libnvidia_tileiras, "libnvidia-tileiras.so.610.43.02")
...
function __init__()
    ...
    JLLWrappers.@init_library_product(
        libnvidia_gpucomp,
        "lib/libnvidia-gpucomp.so.610.43.02",
        nothing,
    )
    ...
    JLLWrappers.@init_library_product(
        libnvidia_tileiras,
        "lib/libnvidia-tileiras.so.610.43.02",
        nothing,
    )
