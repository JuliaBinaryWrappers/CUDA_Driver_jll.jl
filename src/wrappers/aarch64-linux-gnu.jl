...
JLLWrappers.@declare_library_product(libnvidia_gpucomp, "libnvidia-gpucomp.so.595.58.03")
...
JLLWrappers.@declare_library_product(libnvidia_tileiras, "libnvidia-tileiras.so.595.58.03")
...
function __init__()
    ...
    JLLWrappers.@init_library_product(
        libnvidia_gpucomp,
        "lib/libnvidia-gpucomp.so.595.58.03",
        nothing,
    )
    ...
    JLLWrappers.@init_library_product(
        libnvidia_tileiras,
        "lib/libnvidia-tileiras.so.595.58.03",
        nothing,
    )
